...
public sealed class Ticket
{
    ...
    private Ticket(int number, string title, string description, TicketPriority priority, Guid customerId)
    {
        if (number <= 0)
            throw new ArgumentOutOfRangeException(nameof(number), "Ticket number must be greater than zero.");
    ...
    public static Ticket Create(int number, string title, string description, TicketPriority priority, Guid customerId) =>
