...
public static class DatabaseInitializer
{
    ...
    public static async Task SeedAsync(IServiceProvider services, CancellationToken cancellationToken = default)
    {
        ...
        var critical = Ticket.Create("TKT-DEMO-CRITICAL", "Checkout unavailable",
        ...
        var open = Ticket.Create("TKT-DEMO-OPEN", "Update billing address",
            "Please update the billing address used on future invoices for our organization.", TicketPriority.Medium, CustomerId);
        var resolved = Ticket.Create("TKT-DEMO-RESOLVED", "Password reset email delayed",
